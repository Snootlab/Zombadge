...
7/ Dans le terminal exécuter "make survivor-game" puis attendre que le programme s'exécute
...
7/ In the terminal run "make survivor", and wait until the programming session ends
